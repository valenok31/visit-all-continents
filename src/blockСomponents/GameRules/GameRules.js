...
const GameRules = (props) => {
    return <>
        ...
        <div className={style.game_rules}>Die Regeln des Spiels sind sehr einfach. Sie müssen alle Kontinente mit der
            billigsten Route besuchen. Sie
        ...
        <div className={style.game_rules}>Las reglas del juego son muy simples. Es necesario visitar todos los
            continentes por la ruta más barata.
